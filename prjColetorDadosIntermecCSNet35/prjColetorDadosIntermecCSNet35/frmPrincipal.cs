...
namespace prjColetorDadosIntermecCSNet35
{
    public partial class frmPrincipal : Form
    {
        ...
        public static string cntServidorFTP = "srvpatrimonio";
        public static string cntPortaFTP = string.Empty;
        public static string cntUsuarioFTP = "Usuario";
        public static string cntSenhaFTP = string.Empty;
        public static string cntEnderecoArquivoUpload = frmPrincipal.DiretorioEnderecoAplicativo;
        public static string cntNomeArquivoUpload = "tblInventarioBens";
        public static string cntExtensaoArquivoUpload = "txt";

        public static string strServidorFTP = cntServidorFTP;
        public static string strPortaFTP = cntPortaFTP;
        public static string strUsuarioFTP = cntUsuarioFTP;
        public static string strSenhaFTP = cntSenhaFTP;
        public static string strEnderecoArquivoUpload = cntEnderecoArquivoUpload;
        public static string strNomeArquivoUpload = cntNomeArquivoUpload;
        public static string strExtensaoArquivoUpload = cntExtensaoArquivoUpload;
        ...
        private void mni1_Click(object sender, EventArgs e)
        {
            ...
            {
                case "Arquivo":
                    btnEnviarArquivoDados_Click(sender, e);
                    break;
                case "Banco":
                    btnEnviarArquivoDados_Click(sender, e);
                    break;
        ...
        private void frmPrincipal_Load(object sender, EventArgs e)
        {
            ...
            cntEnderecoArquivoUpload = frmPrincipal.DiretorioEnderecoAplicativo;
            ...
            mtdUsuarioFTP();
            mtdSenhaFTP();
            mtdEnderecoArquivoUpload();
            mtdNomeArquivoUpload();
            mtdExtensaoArquivoUpload();
        ...
        private void mtdAjustarDataTempoSistema()
        {
            ...
            System.DateTime dtLocalSistema = System.TimeZone.CurrentTimeZone.ToLocalTime(dtSistema);

            clsDataTempoSistema.mtdAjustarDataTempoSistema(ref dtLocalSistema);
        }
        ...
        private string strEnderecoMapa = "https://www.google.com/maps?q={0},{1}";
        ...
        public void mtdSincronizarHorarioServidor(bool Notificacao)
        {
            try
            {
                ...
                {
                    if ((new clsAjustarDataHoraSistema()).mtdAjustarDataHoraSistema())
                    {
                        if (Notificacao)
                        {
                            try
        ...
        private void mtdCarregarCmbResolucaoFotografia()
        {
            ...
            cmbResolucaoFotografia.Items.Add("96x128");
            cmbResolucaoFotografia.Items.Add("112x160");
            cmbResolucaoFotografia.Items.Add("144x176");
            cmbResolucaoFotografia.Items.Add("240x320");
            cmbResolucaoFotografia.Items.Add("288x352");
            cmbResolucaoFotografia.Items.Add("480x640");
            cmbResolucaoFotografia.Items.Add("480x800");
            cmbResolucaoFotografia.Items.Add("592x800");
            cmbResolucaoFotografia.Items.Add("768x1024");
            cmbResolucaoFotografia.Items.Add("720x1280");
            cmbResolucaoFotografia.Items.Add("960x1280");
            cmbResolucaoFotografia.Items.Add("1072x1920");
            cmbResolucaoFotografia.Items.Add("1200x1600");
            // cmbResolucaoFotografia.Items.Add("1536x2048");
            // cmbResolucaoFotografia.Items.Add("1936x2592");
        ...
        private void mtdIdentificacaoItemGerar()
        {
        ...
        private void mtdOutrosDadosItemGerar()
        {
            int intMes = dtpDataInventario.Value.Month;
            int intAno = dtpDataInventario.Value.Year;
        ...
        private void btnIdentificacaoItemAvancar_Click(object sender, EventArgs e)
        {
            ...
            blnIdentificacaoItemAvancar = blnIdentificacaoItemAvancar ^ true;
        }
        ...
        bool blnOutrosDadosItemAvancar = false;

        private void btnOutrosDadosItemAvancar_Click(object sender, EventArgs e)
        {
            if (blnOutrosDadosItemAvancar)
            {
                mtdOutrosDadosItemAvancar();
            }
            else
            {
                mtdOutrosDadosItemGerar();
            }

            blnOutrosDadosItemAvancar = blnOutrosDadosItemAvancar ^ true;
        }
        ...
        {
            mtdGerarDiretorioBancoDados(@"\SD Card");
        }

        private void btnFlashDisk_Click(object sender, EventArgs e)
        {
            mtdGerarDiretorioBancoDados(@"\Flash File Store");
        }

        private void btnRamDrive_Click(object sender, EventArgs e)
        {
            mtdGerarDiretorioBancoDados(@"\RAM Drive");
        }
        ...
        public StringBuilder mtdConverterTabelaDadosArquivoTXT(DataTable dt)
        {
            ...
            for (int column = 0; column < dt.Columns.Count; column++)
            {
                ...
                if (column == dt.Columns.Count - 1)
                    data.Append(dt.Columns[column].ColumnName.ToString().Replace(",", ","));
                else
                    data.Append(dt.Columns[column].ColumnName.ToString().Replace(",", ",") + '|');
            }
            ...
            for (int row = 0; row < dt.Rows.Count; row++)
            {
                for (int column = 0; column < dt.Columns.Count; column++)
                {
                    ...
                    if (column == dt.Columns.Count - 1)
                        data.Append(dt.Rows[row][column].ToString().Replace(",", ","));
                    else
                        data.Append(dt.Rows[row][column].ToString().Replace(",", ",") + '|');
                }
        ...
        public void mtdSalvarDadosTXT(StringBuilder Dados, string EnderecoArquivo)
        {
            using (System.IO.StreamWriter objWriter = new System.IO.StreamWriter(EnderecoArquivo))
            {
                objWriter.WriteLine(Dados);
                objWriter.Flush();
            }
        }

        private void mtdExportarDadosTabelaInventarioTXT(string EnderecoArquivo, string NomeArquivo, string ExtensaoArquivo)
        {
            clsImplementacaoBancoDados objImplementacaoBancoDados = new clsImplementacaoBancoDados
                (
                clsImplementacaoBancoDados.TipoSistemaGerenciadorBancoDadosRelacional.SQLServerCE
            ...
            try
            {
                ...
                StringBuilder stbDados = mtdConverterTabelaDadosArquivoTXT(objImplementacaoBancoDados.prpTabelaDados);
                mtdSalvarDadosTXT(stbDados, string.Format("{0}{1}.{2}", EnderecoArquivo, NomeArquivo, ExtensaoArquivo));
            }
            catch (System.Exception ex)
            {
                ntf1.Text = "Não foi possível preencher a tabela.";
                string strExcecao = "mtdExportarDadosTabelaInventarioTXT: " + ex.Message;
                System.Diagnostics.Debug.WriteLine(strExcecao);
                //frmPrincipal.mtdGerarRelatorioErros(string.Format(@"{0}Relatorio_Erros.txt", frmPrincipal.DiretorioEnderecoAplicativo), strExcecao);
            }
        ...
        private void mtdFTPUploadArquivo(string ServidorFTP, string PortaFTP, string UsuarioFTP, string SenhaFTP, string EnderecoNomeExtensaoArquivo)
        {
            string[] vetNomeArquivo = EnderecoNomeExtensaoArquivo.Split('\\');
            string[] vetExtensaoArquivo = vetNomeArquivo[vetNomeArquivo.Length - 1].Split('.');
            string strNomeArquivo = vetExtensaoArquivo[0];
            string strExtensaoArquivo = vetExtensaoArquivo[vetExtensaoArquivo.Length - 1];

            string strDiretorioArquivo = string.Empty;

            for (int i = 0; i <= vetNomeArquivo.Length - 2; i++)
            {
                strDiretorioArquivo = string.Format(@"{0}\{1}", strDiretorioArquivo, vetNomeArquivo[i]).Replace(@"\\", @"\");
            }

            mtdFTPUploadArquivo(ServidorFTP, PortaFTP, UsuarioFTP, SenhaFTP, strDiretorioArquivo, strNomeArquivo, strExtensaoArquivo, string.Format(@"{0}.{1}", strNomeArquivo, strExtensaoArquivo));
        }

        private void mtdFTPUploadArquivo(string ServidorFTP, string PortaFTP, string UsuarioFTP, string SenhaFTP, string EnderecoArquivo, string NomeArquivo, string ExtensaoArquivo, string ApelidoArquivo)
        {
            WirelessManager.SetWLANState(true);

            try
            {
                OpenNETCF.Net.Ftp.FTP client = new OpenNETCF.Net.Ftp.FTP();

                if (PortaFTP == string.Empty)
                {
                    client = new OpenNETCF.Net.Ftp.FTP(string.Format("{0}", ServidorFTP));
                }
                else
                {
                    client = new OpenNETCF.Net.Ftp.FTP(string.Format("{0}:{1}", ServidorFTP, PortaFTP));
                }

                if (client != null)
                {
                    client.BeginConnect(UsuarioFTP, SenhaFTP);
                    int numWait = 50;
                    ...
                    if (client.IsConnected)
                    {
                        ...
                        if (ExtensaoArquivo == string.Empty)
                        {
                            client.SendFile(new System.IO.FileStream(string.Format(@"{0}\{1}", EnderecoArquivo, NomeArquivo).Replace(@"\\", @"\"), System.IO.FileMode.Open), ApelidoArquivo);
                        }
                        else
                        {
                            client.SendFile(new System.IO.FileStream(string.Format(@"{0}\{1}.{2}", EnderecoArquivo, NomeArquivo, ExtensaoArquivo).Replace(@"\\", @"\"), System.IO.FileMode.Open), ApelidoArquivo);
                        }
                        client.Disconnect();
                    }
            ...
            {
                string strExcecao = "mtdFTPUploadArquivo: " + ex.Message;
                System.Diagnostics.Debug.WriteLine(strExcecao);
            }
        }

        private void mtdServidorFTP()
        {
            try
            {
                txtServidorFTP.Text = objRegistroWindows.mtdObterDadosRegistro
                    (
                    Microsoft.Win32.Registry.CurrentUser,
                    "Software",
                    "Eletronorte",
            ...
            catch (System.Exception ex)
            {
                ...
                string strExcecao = "mtdServidorFTP: " + ex.Message;
                System.Diagnostics.Debug.WriteLine(strExcecao);
                //frmPrincipal.mtdGerarRelatorioErros(string.Format(@"{0}Relatorio_Erros.txt", frmPrincipal.DiretorioEnderecoAplicativo), strExcecao);
            }
        }

        private void txtServidorFTP_TextChanged(object sender, EventArgs e)
        {
            objRegistroWindows.mtdSalvarDadosRegistro
                (
                Microsoft.Win32.Registry.CurrentUser,
            ...
            strServidorFTP = txtServidorFTP.Text;
        }

        private void mtdPortaFTP()
        {
            try
            {
                txtPortaFTP.Text = objRegistroWindows.mtdObterDadosRegistro
                    (
                    Microsoft.Win32.Registry.CurrentUser,
                    "Software",
                    "Eletronorte",
            ...
            catch (System.Exception ex)
            {
                ...
                string strExcecao = "mtdPortaFTP: " + ex.Message;
                System.Diagnostics.Debug.WriteLine(strExcecao);
                //frmPrincipal.mtdGerarRelatorioErros(string.Format(@"{0}Relatorio_Erros.txt", frmPrincipal.DiretorioEnderecoAplicativo), strExcecao);
            }
        }

        private void txtPortaFTP_TextChanged(object sender, EventArgs e)
        {
            objRegistroWindows.mtdSalvarDadosRegistro
                (
                Microsoft.Win32.Registry.CurrentUser,
            ...
            strPortaFTP = txtPortaFTP.Text;
        }


        private void mtdUsuarioFTP()
        {
            try
            {
                txtUsuarioFTP.Text = objRegistroWindows.mtdObterDadosRegistro
                    (
                    Microsoft.Win32.Registry.CurrentUser,
                    "Software",
                    "Eletronorte",
            ...
            catch (System.Exception ex)
            {
                ...
                string strExcecao = "mtdUsuarioFTP: " + ex.Message;
                System.Diagnostics.Debug.WriteLine(strExcecao);
                //frmPrincipal.mtdGerarRelatorioErros(string.Format(@"{0}Relatorio_Erros.txt", frmPrincipal.DiretorioEnderecoAplicativo), strExcecao);
            }
        }

        private void txtUsuarioFTP_TextChanged(object sender, EventArgs e)
        {
            objRegistroWindows.mtdSalvarDadosRegistro
                (
                Microsoft.Win32.Registry.CurrentUser,
            ...
            strUsuarioFTP = txtUsuarioFTP.Text;
        }

        private void mtdSenhaFTP()
        {
            try
            {
                txtSenhaFTP.Text = objRegistroWindows.mtdObterDadosRegistro
                    (
                    Microsoft.Win32.Registry.CurrentUser,
                    "Software",
                    "Eletronorte",
            ...
            catch (System.Exception ex)
            {
                ...
                string strExcecao = "mtdSenhaFTP: " + ex.Message;
                System.Diagnostics.Debug.WriteLine(strExcecao);
                //frmPrincipal.mtdGerarRelatorioErros(string.Format(@"{0}Relatorio_Erros.txt", frmPrincipal.DiretorioEnderecoAplicativo), strExcecao);
            }
        }

        private void txtSenhaFTP_TextChanged(object sender, EventArgs e)
        {
            objRegistroWindows.mtdSalvarDadosRegistro
                (
                Microsoft.Win32.Registry.CurrentUser,
            ...
            strSenhaFTP = txtSenhaFTP.Text;
        }

        private void mtdEnderecoArquivoUpload()
        {
            try
            {
                txtEnderecoArquivoUpload.Text = objRegistroWindows.mtdObterDadosRegistro
                    (
                    Microsoft.Win32.Registry.CurrentUser,
                    "Software",
                    "Eletronorte",
                    "ColetorDados",
                    "EnderecoArquivoUpload"
                    ).ToString();
            }
            catch (System.Exception ex)
            {
                objRegistroWindows.mtdSalvarDadosRegistro
                    ...
                    "ColetorDados",
                    "EnderecoArquivoUpload",
                    frmPrincipal.DiretorioEnderecoAplicativo,
                    Microsoft.Win32.RegistryValueKind.String
                    );
                string strExcecao = "mtdEnderecoArquivoUpload: " + ex.Message;
                System.Diagnostics.Debug.WriteLine(strExcecao);
                //frmPrincipal.mtdGerarRelatorioErros(string.Format(@"{0}Relatorio_Erros.txt", frmPrincipal.DiretorioEnderecoAplicativo), strExcecao);
            }
        }

        private void txtEnderecoArquivoUpload_TextChanged(object sender, EventArgs e)
        {
            objRegistroWindows.mtdSalvarDadosRegistro
                (
                Microsoft.Win32.Registry.CurrentUser,
                ...
                "ColetorDados",
                "EnderecoArquivoUpload",
                txtEnderecoArquivoUpload.Text,
                Microsoft.Win32.RegistryValueKind.String
                );
            strEnderecoArquivoUpload = txtEnderecoArquivoUpload.Text;
        }


        private void mtdNomeArquivoUpload()
        {
            try
            {
                txtNomeArquivoUpload.Text = objRegistroWindows.mtdObterDadosRegistro
                    (
                    Microsoft.Win32.Registry.CurrentUser,
                    "Software",
                    "Eletronorte",
            ...
            catch (System.Exception ex)
            {
                objRegistroWindows.mtdSalvarDadosRegistro
                    ...
                    "ColetorDados",
                    "NomeArquivoUpload",
                    strNomeArquivoUpload,
                    Microsoft.Win32.RegistryValueKind.String
                    );
                string strExcecao = "mtdNomeArquivoUpload: " + ex.Message;
                System.Diagnostics.Debug.WriteLine(strExcecao);
                //frmPrincipal.mtdGerarRelatorioErros(string.Format(@"{0}Relatorio_Erros.txt", frmPrincipal.DiretorioEnderecoAplicativo), strExcecao);
            }
        }

        private void txtNomeArquivoUpload_TextChanged(object sender, EventArgs e)
        {
            objRegistroWindows.mtdSalvarDadosRegistro
                (
                Microsoft.Win32.Registry.CurrentUser,
                ...
                "ColetorDados",
                "NomeArquivoUpload",
                txtNomeArquivoUpload.Text,
                Microsoft.Win32.RegistryValueKind.String
                );
            strNomeArquivoUpload = txtNomeArquivoUpload.Text;
        }

        private void mtdExtensaoArquivoUpload()
        {
            try
            {
                txtExtensaoArquivoUpload.Text = objRegistroWindows.mtdObterDadosRegistro
                    (
                    Microsoft.Win32.Registry.CurrentUser,
                    "Software",
                    "Eletronorte",
                    "ColetorDados",
                    "ExtensaoArquivoUpload"
                    ).ToString();
            }
            catch (System.Exception ex)
            {
                objRegistroWindows.mtdSalvarDadosRegistro
                    ...
                    "ColetorDados",
                    "ExtensaoArquivoUpload",
                    strExtensaoArquivoUpload,
                    Microsoft.Win32.RegistryValueKind.String
                    );
                string strExcecao = "mtdExtensaoArquivoUpload: " + ex.Message;
                System.Diagnostics.Debug.WriteLine(strExcecao);
                //frmPrincipal.mtdGerarRelatorioErros(string.Format(@"{0}Relatorio_Erros.txt", frmPrincipal.DiretorioEnderecoAplicativo), strExcecao);
            }
        }

        private void txtExtensaoArquivoUpload_TextChanged(object sender, EventArgs e)
        {
            objRegistroWindows.mtdSalvarDadosRegistro
                (
                Microsoft.Win32.Registry.CurrentUser,
                ...
                "ColetorDados",
                "ExtensaoArquivoUpload",
                txtExtensaoArquivoUpload.Text,
                Microsoft.Win32.RegistryValueKind.String
                );
            strExtensaoArquivoUpload = txtExtensaoArquivoUpload.Text;
        }

        private void mtdObterEnderecoArquivoUpload()
        {
            //define as propriedades do controle 
            //OpenFileDialog
            ofd2.InitialDirectory = System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().GetName().CodeBase);

            //filtra para exibir somente arquivos de imagens
            ofd2.Filter = "Todos Arquivos (*.*)|*.*";
            ofd2.FilterIndex = 1;

            DialogResult dr = this.ofd2.ShowDialog();

            string[] vetNomeArquivo = ofd2.FileName.Split('\\');
            string[] vetExtensaoArquivo = vetNomeArquivo[vetNomeArquivo.Length - 1].Split('.');
            string strNomeArquivo = vetExtensaoArquivo[0];
            string strExtensaoArquivo = vetExtensaoArquivo[vetExtensaoArquivo.Length - 1];
            ...
            {
                // Le os arquivos selecionados 
                txtEnderecoArquivoUpload.Text = strDiretorioArquivo;
                txtNomeArquivoUpload.Text = strNomeArquivo;
                txtExtensaoArquivoUpload.Text = strExtensaoArquivo;
            }
        }

        private void mtdGerarArquivoDados_Click(object sender, EventArgs e)
        {
            Cursor.Current = Cursors.WaitCursor; // set the wait cursor
            //Do some work

            mtdDeletarArquivo(string.Format(@"{0}{1}\{2}",txtEnderecoArquivoUpload.Text, txtNomeArquivoUpload.Text, txtExtensaoArquivoUpload.Text).Replace(@"\\",@"\"));
            mtdExportarDadosTabelaInventarioTXT(txtEnderecoArquivoUpload.Text, txtNomeArquivoUpload.Text, txtExtensaoArquivoUpload.Text);

            Cursor.Current = Cursors.Default; //restore the old cursor
        }

        private void btnEnviarArquivoDados_Click(object sender, EventArgs e)
        {
            Cursor.Current = Cursors.WaitCursor; // set the wait cursor
            //Do some work
            ...
            (
                ...
                txtNomeArquivoUpload.Text,
                txtExtensaoArquivoUpload.Text,
                string.Format("{0}.{1}", txtNomeArquivoUpload.Text, txtExtensaoArquivoUpload.Text)
            );

            Cursor.Current = Cursors.Default; //restore the old cursor
        }

        private void btnEnviarBancoDados_Click(object sender, EventArgs e)
        {
            Cursor.Current = Cursors.WaitCursor; // set the wait cursor
            //Do some work
        ...
        private void btnEnviarArquivoDadosBancoDados_Click(object sender, EventArgs e)
        {
            btnEnviarArquivoDados_Click(sender, e);
            btnEnviarBancoDados_Click(sender, e);
        }

        private void btnEnderecoArquivoUpload_Click(object sender, EventArgs e)
        {
            mtdObterEnderecoArquivoUpload();
        }

        private void btnCopiarEnderecoBaseDados_Click(object sender, EventArgs e)
        {
            string[] vetEnderecoArquivoUpload = txtEnderecoBaseDados.Text.Split('\\');
            string strEnderecoArquivoUpload = string.Empty;

            for (int i = 0; i <= vetEnderecoArquivoUpload.Length - 2; i++)
            {
                strEnderecoArquivoUpload = string.Format(@"{0}\{1}", strEnderecoArquivoUpload, vetEnderecoArquivoUpload[i]).Replace(@"\\", @"\");
            }

            txtEnderecoArquivoUpload.Text = strEnderecoArquivoUpload;
        }

        private void btnPadronizarParametros_Click(object sender, EventArgs e)
        {
            txtEnderecoArquivoUpload.Text = cntEnderecoArquivoUpload;
            txtNomeArquivoUpload.Text = cntNomeArquivoUpload;
            txtExtensaoArquivoUpload.Text = cntExtensaoArquivoUpload;
        }

        private bool mtdDeletarArquivo(string NomeArquivo)
        {
            bool Retorno = false;
