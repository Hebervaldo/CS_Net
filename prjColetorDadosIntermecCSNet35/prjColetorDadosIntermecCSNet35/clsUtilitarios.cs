        ...
        public static bool mtdAjustarDataTempoSistema(string EnderecoInternet, string EnderecoRede)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Now.wYear = System.Convert.ToUInt16(Program.objPrincipal.objMonitorCarregamentoDados.wb.mtdObterDataTempoSistemaAtual().Year);
                    Now.wMonth = System.Convert.ToUInt16(Program.objPrincipal.objMonitorCarregamentoDados.wb.mtdObterDataTempoSistemaAtual().Month);
                    Now.wDay = System.Convert.ToUInt16(Program.objPrincipal.objMonitorCarregamentoDados.wb.mtdObterDataTempoSistemaAtual().Day);
                    Now.wHour = System.Convert.ToUInt16(Program.objPrincipal.objMonitorCarregamentoDados.wb.mtdObterDataTempoSistemaAtual().Hour);
                    Now.wMinute = System.Convert.ToUInt16(Program.objPrincipal.objMonitorCarregamentoDados.wb.mtdObterDataTempoSistemaAtual().Minute);
                    Now.wSecond = System.Convert.ToUInt16(Program.objPrincipal.objMonitorCarregamentoDados.wb.mtdObterDataTempoSistemaAtual().Second);
                    Now.wMilliseconds = System.Convert.ToUInt16(Program.objPrincipal.objMonitorCarregamentoDados.wb.mtdObterDataTempoSistemaAtual().Millisecond);
