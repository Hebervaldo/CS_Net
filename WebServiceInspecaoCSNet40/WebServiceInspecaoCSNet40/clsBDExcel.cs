...
namespace WebServiceInspecaoCSNet40
{
    ...
    {
        public static List<string> lstMensagemErro = new List<string>();
        ...
        public static string getMensagemErro
        {
            get
            {
                ...
                for (int contador = 0; contador <= lstMensagemErro.Count - 1; contador++)
                {
                    if (contador == lstMensagemErro.Count - 1)
                    {
                        strPontuacao = ".";
                    }

                    strMensagemErro = string.Format("{0} - {1}{2}", contador, lstMensagemErro[contador], strPontuacao);
                }
    ...
    public partial class clsImplementacaoBancoDados
    {
        ...
        public bool mtdAbrirInserirPlanilhaExcel_Otimizado(string EnderecoArquivo, string NomeTabela)
        {
            ...
            try
            {
                ...
                {
                    lstMensagemErro.Clear();
                    lstMensagemErro.Add(ex.Message);
                }
