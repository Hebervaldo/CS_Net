...
{
    public class clsAutorizacaoRegistroWindows
    {
        private string user = System.Environment.UserDomainName + @"\" + System.Environment.UserName;

        private System.Security.AccessControl.RegistrySecurity rs = new System.Security.AccessControl.RegistrySecurity();

        public System.Security.AccessControl.RegistrySecurity mtdAutorizarUsuarioControleTotalChaveRegistroWindows()
        {
            return mtdAutorizarUsuarioControleTotalChaveRegistroWindows(user);
        }

        public void mtdAutorizarUsuarioControleTotalChaveRegistroWindows(ref System.Security.AccessControl.RegistrySecurity rs)
        {
            rs = mtdAutorizarUsuarioControleTotalChaveRegistroWindows(user);
        }

        public void mtdAutorizarUsuarioControleTotalChaveRegistroWindows(string Usuario, ref System.Security.AccessControl.RegistrySecurity rs)
        {
            rs = mtdAutorizarUsuarioControleTotalChaveRegistroWindows(Usuario);
        }

        // Allow the current user to read and delete the key.
        public System.Security.AccessControl.RegistrySecurity mtdAutorizarUsuarioControleTotalChaveRegistroWindows(string Usuario)
        {
            rs = new System.Security.AccessControl.RegistrySecurity();
    ...
    public class clsRegistroWindows
    {
        ...
        public bool mtdDeletarDadosRegistro()
        {
            try
            {
                ...
                regKey = regKey.OpenSubKey(System.Convert.ToString(getSecao), true);
                regKey = regKey.OpenSubKey(System.Convert.ToString(getChave), true);
                regKey.DeleteValue(System.Convert.ToString(getValor), true);
                erro = true;
    ...
    public class clsTemporizador
    {
        ...
        [System.Runtime.InteropServices.DllImport("kernel32.dll", CharSet = System.Runtime.InteropServices.CharSet.Auto, SetLastError = true, ExactSpelling = true)]
    ...
    public class clsArquivoTXT : object
    {
        ...
        public bool mtdAcrescentarTexto()
        {
            ...
            try
            {
                System.IO.StreamReader stdLeitorTexto = System.IO.File.OpenText(getEnderecoArquivo);
