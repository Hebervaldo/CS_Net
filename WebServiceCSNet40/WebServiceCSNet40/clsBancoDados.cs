...
namespace WebServiceCSNet40
{
    public partial class clsBancoDados : IDisposable
    {
        ...
        private System.Data.DataSet objAjustadorDados = new System.Data.DataSet();
        ...
        public string mtdObterCabecalhoColunas(int Coluna, bool Otimizacao)
        {
        ...
        public void mtdObterCabecalhoColunas(ref string[] Colunas, bool Otimizacao)
        {
            Colunas = mtdObterCabecalhoColunas(Otimizacao);
        }

        public string[] mtdObterCabecalhoColunas(bool Otimizacao)
        {
            lock (LockBancoDados)
            {
        ...
        public string mtdObterTipoRegistro(int Coluna)
        {
        ...
        public void mtdObterTipoRegistro(ref string[] Colunas)
        {
            Colunas = mtdObterTipoRegistro();
        }

        public string[] mtdObterTipoRegistro()
        {
            return mtdObterTipoRegistro(prpTabela, prpComando);
        }

        public string[] mtdObterTipoRegistro(string Comando)
        {
            return mtdObterTipoRegistro(prpTabela, Comando);
        }

        public string[] mtdObterTipoRegistro(string Tabela, string Comando)
        {
            return mtdObterTipoRegistro(Tabela, Comando, true);
        }

        public string[] mtdObterTipoRegistro(string Tabela, string Comando, bool Otimizacao)
        {
            lock (LockBancoDados)
            {
                strExcecao = "mtdObterTipoRegistro: Nao houve excecao.";
                int intNumeroColunas = 0;
                string[] vetTipos = null;
                try
                {
                    if (Otimizacao)
                    {
                        ...
                        prpComando = Comando;
                        intNumeroColunas = mtdNumeroColunas();
                        vetTipos = new string[intNumeroColunas];
                        for (int contador = 0; contador <= intNumeroColunas - 1; contador++)
                        {
                            switch (enuTipoSistemaGerenciadorBancoDadosRelacional)
                            {
        ...
        public void mtdObterCabecalhoTipoRegistro(string[][] CabecalhoTipoRegistro)
        {
            CabecalhoTipoRegistro = new string[2][] {
			mtdObterCabecalhoColunas(),
			mtdObterTipoRegistro()
		};
        }

        public void mtdObterCabecalhoTipoRegistro(int Coluna, string[] CabecalhoTipoRegistro)
        {
            CabecalhoTipoRegistro = new string[2] {
        ...
        public void mtdObterCabecalhoTipoRegistro(string Coluna, string[] CabecalhoTipoRegistro)
        {
            CabecalhoTipoRegistro = new string[2] {
        ...
        public string[][] mtdObterCabecalhoTipoRegistro()
        {
            return new string[2][] {
			mtdObterCabecalhoColunas(),
			mtdObterTipoRegistro()
        ...
        public string[] mtdObterCabecalhoTipoRegistro(int Coluna)
        {
            return new string[2] {
			mtdObterCabecalhoColunas(Coluna),
			mtdObterTipoRegistro(Coluna)
        ...
        public string[] mtdObterCabecalhoTipoRegistro(string Coluna)
        {
            return new string[2] {
			mtdObterCabecalhoColunas(mtdObterNumeroColuna(Coluna)),
			mtdObterTipoRegistro(mtdObterNumeroColuna(Coluna))
            ...
            lock (LockBancoDados)
            {
                ...
                try
                {
                    switch (enuTipoSistemaGerenciadorBancoDadosRelacional)
                    {
                        ...
                        //    break;
                        case TipoSistemaGerenciadorBancoDadosRelacional.OleDb:
                            if (saida = objLeitorDadosOleDb != null)
                            {
